...
import br.com.mercadoenvios.logitrack.domain.usecase.validations.parcel.UpdateParcelValidation;
...
public class UpdateParcelService {
    ...
    private final UpdateParcelValidation validation;
    private final ParcelMapper parcelMapper;
    private final ParcelEntityMapper parcelEntityMapper;

    public Mono<Parcel> updateStatusParcel(Parcel parcel) {
    ...
    private Mono<Void> updateParcel(ParcelEntity parcelEntity) {
        return parcelEntity.status().equals(Parcel.Status.DELIVERED.name())
                ? repository.updateDeliveredParcel(parcelEntity)
                : repository.updateStatusParcel(parcelEntity);
    }
}
